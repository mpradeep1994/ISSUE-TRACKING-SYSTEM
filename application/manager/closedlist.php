...
<div class='main'>
 <div id='caption'>Closed Issues</div>
 </br></br>
 <table border="1" cellspacing=0 cellpadding=5 align="center">
  ...
  <?php
   $sql="SELECT a.ticketid,b.issuetitle,b.assignedto,b.assignedby,b.status,b.time FROM issueclient a,issuedetails b where a.ticketid=b.ticketid AND b.status='CLOSED (cannot be resolved)' ORDER BY a.time DESC";
