...
?>
<div class='main'>
 <div id='caption'> Assign Issue To Employee</div>
 </br>
	<div id='reassign'>
	 <?php
     ...
     ?>
     <tr><td>Assign ISSUE To</td><td><table border='1' cellspacing=0 cellpadding=5>
	  <tr><th>Select</th><th>Available Users in our Company</th></tr>
		<?php
		echo "<form action='reassign_list.php?id=".$ticketid."' method='post'>";
		while($list=mysqli_fetch_array($result))
		{
         echo "<tr><td><input type='radio' name='emp' value='".$list['username']."'></td><td>".$list['username']."</td></tr>"; 
