...
<div class='main'>
 ...
 <table border="1" cellspacing=0 cellpadding=5 align="center">
  ...
  <?php
   $sql="SELECT a.ticketid,b.issuetitle,a.name,a.email,a.mobile,a.address,a.time,b.assignedto,b.assignedby,b.priority,b.status,b.issuedesc FROM issueclient a,issuedetails b where a.ticketid=b.ticketid AND b.assignedto='".$_SESSION['username']."' AND (b.status='Under Investigation' OR b.status='processing' OR b.status='New')";
